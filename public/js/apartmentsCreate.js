...
/***/ "./resources/js/apartmentsCreate.js":
/*!******************************************!*\
  !*** ./resources/js/apartmentsCreate.js ***!
  \******************************************/
/*! no exports provided */
...
var inputAddress = document.getElementById('address'); //# lista autocomplete address and cities

var addressList = document.getElementById('addressList'); //#parte da city

var address = ""; // % chiamata api città +  address
...
inputAddress.addEventListener('keyup', function () {
  if (this.value.length >= 4) {
    if (this.value.length % 2 == 0) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("https://api.tomtom.com/search/2/search/".concat(query, ".json?countrySet=IT"), {
        params: {
        ...
        console.log(list); //get list address with only name

        var addressesNames = getAddressName(list); //insert element inside the suggest
...
/***/ 2:
/*!************************************************!*\
  !*** multi ./resources/js/apartmentsCreate.js ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
