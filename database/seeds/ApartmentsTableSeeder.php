...
class ApartmentsTableSeeder extends Seeder
{
    ...
    public function run(Faker $faker)
    {
        ...
        $addresses = ["piazza san vito albano di lucania", "Corso Manfredi Lucera FG","Strada Provinciale Torremaggiore FG","Via Damiano Chiesa 00136 Roma RM", 'Via Plinio','Via Cola di Rienzo','Via Nicola Ricciotti','Via Costabella','Via Felice Cavallotti','Via Pietro Giannone','Via Piazzolla','Via De Marco Carlo','Via Antonio Ciccone','Via Bartolomeo Chioccarelli','Viale Cirenaica', 'Viale Derna','Viale Dandolo','Viale Colombo','Via Teofilo Folengo','Via Borgospesso','Vicolo Giardino','Via Romagnosi','Via Clerici','Via Cheren',
        ];
